...
$stmt = $db->prepare('SELECT * FROM tblPosts WHERE PostID = :postid');
...
$indStmt = $stmt->fetch();
  ...
  $PostID = null;
  echo "There Is no username supplied";
}
    ...
    <div class="col s12 m12 l12">
      <div class="card white" style="<?php if(!isset($_SESSION['email'])) echo 'display:none;';?>">
        <div class="card-content grey darken-4 white-text">
          ...
          <p class="center">Edit Status</p>
        <div class="chip">
    <img src="images/profile-pic.jpg">
    <?php echo $_SESSION['username']?>
       </div>
      </span>
      <form action="models/editPost.php" method="POST">
      ...
      <input type='hidden' name="post_id" value="<?php echo $indStmt['PostID'] ?>">
        <input class="white-text" id="edit_post" value="<?php echo $indStmt["Post"]?>" name="edit_post_message" type="text" class="validate"/>
        <button style="border-radius:5px;" class="btn waves-effect waves-light red" type="submit" name="action">Edit Post</button>
